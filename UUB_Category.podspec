...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is UUB_Category
                   DESC

  s.homepage     = "https://github.com/willokyes/UUB_Category"
  ...
  s.source       = { :git => "https://github.com/willokyes/UUB_Category.git", :tag => s.version.to_s }
  ...
  s.source_files  = "UUB_Category/UUB_Category/**/*.{h,m,swift}"
